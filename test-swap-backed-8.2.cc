 ...
 * from it and write to reset it. then read it, write it, 
 * and read it again. this should not change state.
 */
...
int main() {
	...
	// now write to it. this should not change the state
	spotHolder1[0] = 'B';

	// now read from it again. this should not change the state
	cout << spotHolder1[0] << endl;
